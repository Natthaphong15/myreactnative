    ...
    return (
        <View>
            ...
            <View style={{ flexDirection: "row", marginVertical: 10 }}>
                {/* ซ้าย < */}
                <View style={{
                    flex: 1, backgroundColor: 'white', marginRight: 10, height: 100,justifyContent: 'center', alignItems: "center", borderRadius: 10
                }}>
                    <Text>Bmi :{bmi}</Text>
                </View>
                {/* ขวา > */}
                <View style={{
                    flex: 1, backgroundColor: 'white', marginLeft: 10, height: 100,justifyContent: 'center', alignItems: "center", borderRadius: 10
                }}>
